        ...
        if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
          ...
          if (VCAST_FIND_INDEX() == -1) {
            ...
            *VCAST_TI_9_20_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_20_array_size*(sizeof(Ifx_SCU_CCUCON5 )));
            VCAST_memset((void*)*vcast_param, 0x0, VCAST_TI_9_20_array_size*(sizeof(Ifx_SCU_CCUCON5 )));
        ...
        if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
          ...
          if (VCAST_FIND_INDEX() == -1) {
            ...
            *VCAST_TI_9_2_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_2_array_size*(sizeof(struct order_type )));
            VCAST_memset((void*)*vcast_param, 0x0, VCAST_TI_9_2_array_size*(sizeof(struct order_type )));
#ifndef VCAST_NO_MALLOC
...
void VCAST_TI_9_19 ( Ifx_SCU_CCUCON5 *vcast_param ) 
{
...
#else /*((defined(VCAST_NO_TYPE_SUPPORT))||(defined(VCAST_NO_UNION_SUPPORT)))*/
  {
    ...
    VCAST_TI_9_18_jmpval = setjmp ( VCAST_env );
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 1: { 
        VCAST_LONGEST_INT VCAST_TI_9_4_ti_bitfield_placeholder = (VCAST_LONGEST_INT) vcast_param->MAXDIV;
      ...
      case 2: { 
        VCAST_LONGEST_INT VCAST_TI_9_4_ti_bitfield_placeholder = (VCAST_LONGEST_INT) vcast_param->reserved_4;
      ...
      case 3: { 
        VCAST_LONGEST_INT VCAST_TI_9_4_ti_bitfield_placeholder = (VCAST_LONGEST_INT) vcast_param->UP;
      ...
      case 4: { 
        VCAST_LONGEST_INT VCAST_TI_9_4_ti_bitfield_placeholder = (VCAST_LONGEST_INT) vcast_param->LCK;
        VCAST_TI_BITFIELD ( & VCAST_TI_9_4_ti_bitfield_placeholder, 1, vCAST_false );
