...
/** This function concatenates VC_T to the end of VC_S */
...
{
   vCAST_boolean vcastIsDecimal = 0;
   vCAST_boolean vcastOnlyZero = 1;
   ...
   return ((!vcastIsDecimal) || (vcastIsDecimal && vcastOnlyZero));
}
...
{
   return vCAST_ITERATION_COUNTERS[UNIT-8][SUB];
}

void vCAST_INCREMENT_ITERATION_COUNTER(int UNIT, int SUB)
{
   vCAST_ITERATION_COUNTERS[UNIT-8][SUB]++;
}
