 ...
 * Name: manager
 *
 * Path: C:/VCAST/Tutorial/c/manager.c
 *
 ...
 *   mcdc bit array 0:....................size (bits): 2   count: 12     bytes:  3

 *   mcdc bit array 1:....................size (bits): 4   count: 3      bytes:  2
 ...
 *   Total (no MC/DC pool storage):......................................bytes:  26 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  16026 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  32026 *
 ...
 *   Total (with user configurable MC/DC pool storage):..................bytes:  44026 *
  ...
  switch ( VCAST_SUB_INDEX ) {
    case 0: /* for global objects */
      switch( VCAST_PARAM_INDEX ) {
        case 1: /* for global object vcast_SCU_CCUCON5 */
          VCAST_TI_9_20 ( &(vcast_SCU_CCUCON5));
          break;
        case 2: /* for global object WaitingList */
          VCAST_TI_9_15 ( WaitingList);
          break;
        case 3: /* for global object WaitingListSize */
          VCAST_TI_9_4 ( &(WaitingListSize));
          break;
        case 4: /* for global object WaitingListIndex */
    ...
    case 8: /* function Get_Table_Record */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_9_22 ( &(P_10_1_1));
          break;
        case 2:
          VCAST_TI_9_9 ( &(R_10_1));
          break;
    ...
    case 9: /* function Update_Table_Record */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_9_22 ( &(P_10_2_1));
          break;
        case 2:
    ...
    case 3: /* function Place_Order */
      switch ( VCAST_PARAM_INDEX ) {
        case 1:
          VCAST_TI_9_22 ( &(P_9_3_1));
          break;
        case 2:
          VCAST_TI_9_22 ( &(P_9_3_2));
          break;
        case 3:
          VCAST_TI_9_8 ( &(P_9_3_3));
          break;
        case 4:
          VCAST_TI_8_2 ( &(R_9_3));
          break;
      ...
      if ( (vCAST_COMMAND_IS_MIN_MAX == vCAST_true) &&( VCAST_FIND_INDEX() < 0 ) ) {
        ...
        if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
          ...
          if (VCAST_FIND_INDEX() == -1) {
            ...
            *VCAST_TI_9_20_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_20_array_size*(sizeof(Ifx_SCU_CCUCON5 )));
            memset((void*)*vcast_param, 0x0, VCAST_TI_9_20_array_size*(sizeof(Ifx_SCU_CCUCON5 )));
            ;
          }
          ...
          VCAST_TI_9_19 ( &((*vcast_param)[VCAST_TI_9_20_index]));
        }
      }
    }
  }
    ...
    if ( vCAST_SIZE && (!VCAST_TI_9_15_more_data)) { /* get the size of the array */
      ...
      for (VCAST_TI_9_15_array_index=0; VCAST_TI_9_15_array_index< VCAST_TI_9_15_upper; VCAST_TI_9_15_array_index++){
        if ( (VCAST_TI_9_15_index >= VCAST_TI_9_15_first) && ( VCAST_TI_9_15_index <= VCAST_TI_9_15_last)){
          VCAST_TI_9_24 ( vcast_param[VCAST_TI_9_15_index]);
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 2: {
        VCAST_TI_9_22 ( &(vcast_param->Number_In_Party));
        break; /* end case 2*/
      } /* end case */
      ...
      case 4: {
        VCAST_TI_9_23 ( vcast_param->Wait_Person);
        break; /* end case 4*/
      } /* end case */
      ...
      if ( (vCAST_COMMAND_IS_MIN_MAX == vCAST_true) &&( VCAST_FIND_INDEX() < 0 ) ) {
        ...
        if (vCAST_COMMAND == vCAST_ALLOCATE && vcast_proc_handles_command(1)) {
          ...
          if (VCAST_FIND_INDEX() == -1) {
            ...
            *VCAST_TI_9_2_memory_ptr = (void*)VCAST_malloc(VCAST_TI_9_2_array_size*(sizeof(struct order_type )));
            memset((void*)*vcast_param, 0x0, VCAST_TI_9_2_array_size*(sizeof(struct order_type )));
            ;
          }
        } else if (vCAST_VALUE_NUL == vCAST_true && vcast_proc_handles_command(1)) {
          if (VCAST_FIND_INDEX() == -1)
          ...
          VCAST_TI_9_8 ( &((*vcast_param)[VCAST_TI_9_2_index]));
        }
      }
    }
  }
...
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      ...
      case 3: {
        VCAST_TI_9_3 ( &(vcast_param->Entree));
        break; /* end case 3*/
      } /* end case */
...
{
  {
    int VCAST_TI_9_18_jmpval;
    VCAST_TI_9_18_jmpval = 
                          _setjmp(
                          VCAST_env
                          )
                                              ;
    vcast_is_in_union = vCAST_false;
    if ( VCAST_TI_9_18_jmpval == 0 ) {
      vcast_is_in_union = vCAST_true;
      switch ( vcast_get_param () ) { /* Choose field member */
        /* Setting member variable vcast_param->U */
        case 1: {
          VCAST_TI_9_4 ( &(vcast_param->U));
          break; /* end case 1*/
        } /* end case */
        /* Setting member variable vcast_param->I */
        case 2: {
          VCAST_TI_9_17 ( &(vcast_param->I));
          break; /* end case 2*/
        } /* end case */
        /* Setting member variable vcast_param->B */
        case 3: {
          VCAST_TI_9_16 ( &(vcast_param->B));
          break; /* end case 3*/
        } /* end case */
        default:
          vCAST_TOOL_ERROR = vCAST_true;
...
{
  {
    int VCAST_TI_9_24_array_index = 0;
    int VCAST_TI_9_24_index = 0;
    int VCAST_TI_9_24_first, VCAST_TI_9_24_last;
    int VCAST_TI_9_24_more_data; /* true if there is more data in the current command */
    int VCAST_TI_9_24_local_field = 0;
    int VCAST_TI_9_24_value_printed = 0;
    int VCAST_TI_9_24_is_string = (VCAST_FIND_INDEX()==-1);
    vcast_get_range_value (&VCAST_TI_9_24_first, &VCAST_TI_9_24_last, &VCAST_TI_9_24_more_data);
    VCAST_TI_9_24_local_field = vCAST_DATA_FIELD;
    if ( vCAST_SIZE && (!VCAST_TI_9_24_more_data)) { /* get the size of the array */
      vectorcast_fprint_integer (vCAST_OUTPUT_FILE,32);
      vectorcast_fprint_string (vCAST_OUTPUT_FILE,"%%\n");
      vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n");
    } else {
      int VCAST_TI_9_24_upper = 32;
      for (VCAST_TI_9_24_array_index=0; VCAST_TI_9_24_array_index< VCAST_TI_9_24_upper; VCAST_TI_9_24_array_index++){
        if ( (VCAST_TI_9_24_index >= VCAST_TI_9_24_first) && ( VCAST_TI_9_24_index <= VCAST_TI_9_24_last)){
          if ( VCAST_TI_9_24_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, sizeof ( vcast_param ), 1,VCAST_TI_9_24_upper);
          else
            VCAST_TI_8_1 ( &(vcast_param[VCAST_TI_9_24_index]));
          VCAST_TI_9_24_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_9_24_local_field;
        } /* if */
        if (VCAST_TI_9_24_index >= VCAST_TI_9_24_last)
          break;
        VCAST_TI_9_24_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_9_24_value_printed))
        vectorcast_fprint_string(vCAST_OUTPUT_FILE,"<<past end of array>>\n");
    } /* if */
  }
} /* end VCAST_TI_9_24 */
...
{
  {
    int VCAST_TI_9_23_array_index = 0;
    int VCAST_TI_9_23_index = 0;
    int VCAST_TI_9_23_first, VCAST_TI_9_23_last;
    int VCAST_TI_9_23_more_data; /* true if there is more data in the current command */
    int VCAST_TI_9_23_local_field = 0;
    int VCAST_TI_9_23_value_printed = 0;
    int VCAST_TI_9_23_is_string = (VCAST_FIND_INDEX()==-1);
    vcast_get_range_value (&VCAST_TI_9_23_first, &VCAST_TI_9_23_last, &VCAST_TI_9_23_more_data);
    VCAST_TI_9_23_local_field = vCAST_DATA_FIELD;
    if ( vCAST_SIZE && (!VCAST_TI_9_23_more_data)) { /* get the size of the array */
      vectorcast_fprint_integer (vCAST_OUTPUT_FILE,10);
      vectorcast_fprint_string (vCAST_OUTPUT_FILE,"%%\n");
      vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n");
    } else {
      int VCAST_TI_9_23_upper = 10;
      for (VCAST_TI_9_23_array_index=0; VCAST_TI_9_23_array_index< VCAST_TI_9_23_upper; VCAST_TI_9_23_array_index++){
        if ( (VCAST_TI_9_23_index >= VCAST_TI_9_23_first) && ( VCAST_TI_9_23_index <= VCAST_TI_9_23_last)){
          if ( VCAST_TI_9_23_is_string )
            VCAST_TI_STRING ( (char**)&vcast_param, sizeof ( vcast_param ), 1,VCAST_TI_9_23_upper);
          else
            VCAST_TI_8_1 ( &(vcast_param[VCAST_TI_9_23_index]));
          VCAST_TI_9_23_value_printed = 1;
          vCAST_DATA_FIELD = VCAST_TI_9_23_local_field;
        } /* if */
        if (VCAST_TI_9_23_index >= VCAST_TI_9_23_last)
          break;
        VCAST_TI_9_23_index++;
      } /* loop */
      if ((vCAST_COMMAND == vCAST_PRINT)&&(!VCAST_TI_9_23_value_printed))
        vectorcast_fprint_string(vCAST_OUTPUT_FILE,"<<past end of array>>\n");
    } /* if */
  }
} /* end VCAST_TI_9_23 */
...
void VCAST_TI_9_16 ( struct _Ifx_SCU_CCUCON5_Bits *vcast_param )
{
  {
    switch ( vcast_get_param () ) { /* Choose field member */
      /* Setting member variable vcast_param->MAXDIV */
      case 1: {
        long long VCAST_TI_9_4_ti_bitfield_placeholder = (long long) vcast_param->MAXDIV;
        VCAST_TI_BITFIELD ( & VCAST_TI_9_4_ti_bitfield_placeholder, 4, vCAST_false );
        vcast_param->MAXDIV = ( unsigned ) VCAST_TI_9_4_ti_bitfield_placeholder;
        break; /* end case 1*/
      } /* end case */
      /* Setting member variable vcast_param->reserved_4 */
      case 2: {
        long long VCAST_TI_9_4_ti_bitfield_placeholder = (long long) vcast_param->reserved_4;
        VCAST_TI_BITFIELD ( & VCAST_TI_9_4_ti_bitfield_placeholder, 26, vCAST_false );
        vcast_param->reserved_4 = ( unsigned ) VCAST_TI_9_4_ti_bitfield_placeholder;
        break; /* end case 2*/
      } /* end case */
      /* Setting member variable vcast_param->UP */
      case 3: {
        long long VCAST_TI_9_4_ti_bitfield_placeholder = (long long) vcast_param->UP;
        VCAST_TI_BITFIELD ( & VCAST_TI_9_4_ti_bitfield_placeholder, 1, vCAST_false );
        vcast_param->UP = ( unsigned ) VCAST_TI_9_4_ti_bitfield_placeholder;
        break; /* end case 3*/
      } /* end case */
      /* Setting member variable vcast_param->LCK */
      case 4: {
        long long VCAST_TI_9_4_ti_bitfield_placeholder = (long long) vcast_param->LCK;
        VCAST_TI_BITFIELD ( & VCAST_TI_9_4_ti_bitfield_placeholder, 1, vCAST_false );
        vcast_param->LCK = ( unsigned ) VCAST_TI_9_4_ti_bitfield_placeholder;
        break; /* end case 4*/
      } /* end case */
      default:
        vCAST_TOOL_ERROR = vCAST_true;
...
void VCAST_TI_RANGE_DATA_9 ( void ) {
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, "NEW_SCALAR\n" );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"900019\n" );
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, "NEW_SCALAR\n" );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"900020\n" );
  ...
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"\n" );
  /* Range Data for TI (array) VCAST_TI_9_23 */
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, "NEW_ARRAY\n" );
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"100006\n" );
  vectorcast_fprint_integer (vCAST_OUTPUT_FILE,10);
  vectorcast_fprint_string (vCAST_OUTPUT_FILE,"%%\n");
  /* Range Data for TI (array) VCAST_TI_9_24 */
  vectorcast_fprint_string (vCAST_OUTPUT_FILE, "NEW_ARRAY\n" );
